  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience Coffee Shop - Your One-Stop Web Application for all Coffee Shops! Browse Products, Manage Accounts, Review Past Orders, and Discover More. Seamless, Simple, Satisfying."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1453614512568-c4024d13c247?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjb2ZmZWUlMjBzaG9wfGVufDB8fHx8MTY5NTM5MzA0Mnww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@nputra?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Nafinia Putra`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience Coffee Shop - Your One-Stop Web Application for all Coffee Shops! Browse Products, Manage Accounts, Review Past Orders, and Discover More. Seamless, Simple, Satisfying.`}
            </Text>
            <Box
