...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'OrderCreated.create': { roles: ['manager', 'business-owner'], key: 'orderId', tenantPath: [], userPath: [] },
  'PaymentReceived.create': { roles: ['manager', 'business-owner'], key: 'paymentId', tenantPath: [], userPath: [] },
  'ItemAdded.create': { roles: ['manager'], key: 'itemId', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['manager'];
const customerRoles: string[] = ['customer'];
const tenantRoles: string[] = ['manager', 'business-owner', 'customer'];
